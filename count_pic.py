...
class DetectionAnalyzer:
    def __init__(self):
        ...
        self.device_areas = {
            ...
            'f2a02747dd65c8d1': {
                ...
                'Area E': {
                    'polygon': [(0, 824), (792, 790), (1577, 1718), (0, 2316)]
                },
                'Area F': {
                    'polygon': [(1577, 1718), (3313, 1070), (4160, 1399), (4160, 3120), (2360, 3120)]
                }
            },
            'afcc7a113c41f44e': {
                'Area A': {
                ...
                'Area D': {
                    'polygon': [(0, 784), (0, 1365), (952, 1682), (1692, 874), (523, 824)]
                },
                'Area F': {
                    'polygon': [(952, 1682), (1692, 874), (4160, 804), (4160, 1892), (1771, 2953)]
                }
            }
        }
    ...
    def draw_visualization(self, image_path: str, bboxes: List[Dict], device_id: str, output_path: str):
        ...
        # エリアを描画
        if device_id in self.device_areas:
            colors = [
                (255, 102, 102), (102, 255, 102), (102, 178, 255),
                (255, 255, 102), (255, 153, 255), (153, 255, 255),
                (255, 204, 153), (204, 153, 255)
            ]
            for i, (area_name, area_data) in enumerate(self.device_areas[device_id].items()):
...
def main():
    ...
    output_dir = "C:\\Users\\keisu\\Desktop\\function\\function\\output\\simple"
